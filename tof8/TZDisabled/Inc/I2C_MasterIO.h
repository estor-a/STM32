...
//======== 8>< ---------------------------
// Brisk specific
void Brisk_I2C_MasterIO_Init(void); //ae brick ...
void Brisk_I2C_MasterIO_Test(void); //ae brisk  
extern I2C_MasterIO_t gI2C_Bus_Sensor;
extern I2C_MasterIO_t gI2C_Bus_DigitalHeader; //ae g_ pour les global 
