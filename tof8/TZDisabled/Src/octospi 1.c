...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  */
    PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_OCTOSPI1;  //RCC_PERIPHCLK_OSPI;
    PeriphClkInitStruct.Octospi1ClockSelection = RCC_OCTOSPICLKSOURCE_SYSCLK;//RCC_OCTOSPI1_CLKSOURCE_HCLK;
