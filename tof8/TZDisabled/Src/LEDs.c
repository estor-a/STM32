...
const IO_Pad_t LED1_AsOutput = {  LD1_, { .Mode = IO_OUTPUT, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH } }; // LED1 = PC7 Digital Output
const IO_Pad_t LED1_AsPWM =    {  LD1_, { .Mode = IO_SIGNAL, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH, .Signal = TIM15_CH2 } }; 

const IO_Pad_t LED2_AsOutput = {  LD2_, { .Mode = IO_OUTPUT, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH } }; // LED1 = PC7 Digital Output
const IO_Pad_t LED2_AsPWM =    {  LD2_, { .Mode = IO_SIGNAL, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH, .Signal = TIM15_CH1 } }; 

const IO_Pad_t LED3_AsOutput = {  LD3_, { .Mode = IO_OUTPUT, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH } }; // LED1 = PC7 Digital Output
const IO_Pad_t LED3_AsPWM =    {  LD3_, { .Mode = IO_SIGNAL, .Drive = IO_PUSHPULL, .Pull = IO_NOPULL, .Speed = IO_SPEED_01, .Odr = IO_ODR_HIGH, .Signal = LPTIM2_CH1 } }; 
...
// Timed LED
TimedLED_t TimedLEDs[LED_COUNT] = {
  { 0, 0, 0, 0,  0, 0,},
...
void BriskDimLED(uint8_t index, int8_t percentage) {// a negative value will turn the LED OFF (toggling the sign is used for blinking implementation)
  ...
  TimedLEDs[index].Dim_perc = percentage; // save the used percentage dimming value
}
